...
class TokenError(HTTPException):
    def __init__(self, detail: str = "An error occurred while decrypting your token", status_code: int = 403):
        super().__init__(status_code=status_code, detail=detail)
...
class RedisError(HTTPException):
    def __init__(self, detail: str = "Please, log in again!", status_code: int = 500):
        super().__init__(status_code=status_code, detail=detail)
